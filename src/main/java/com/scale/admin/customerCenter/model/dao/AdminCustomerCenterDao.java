...
public class AdminCustomerCenterDao {
	
private Properties prop = new Properties();
	
	public AdminCustomerCenterDao() {
		String filePath = CustomerCenterDao.class.getResource("/db/sql/admin-customerCenter-mapper.xml").getPath();
