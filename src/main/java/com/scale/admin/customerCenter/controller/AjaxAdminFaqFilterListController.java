...
/**
 * Servlet implementation class AjaxFaqFilterListController
 */
@WebServlet("/faqFilter.ad")
public class AjaxAdminFaqFilterListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxAdminFaqFilterListController() {
        super();
