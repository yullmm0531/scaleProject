...
public class AdminUser {
	...
	public AdminUser(int userNo, String userId, String userPwd, String userName, String userNickName, String phone,
	...
	public AdminUser(int userNo, String userId, String userPwd, String userName, String phone, String email,
			Date enrollDate, String status, Date deleteDate, String managerCheck) {
		super();
		this.userNo = userNo;
		this.userId = userId;
		this.userPwd = userPwd;
